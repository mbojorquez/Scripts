...
'set gxout shaded'
'/home/mbojorquez/gscript/color2 1 10 1 -kind white->salmon->crimson->yellow'
'd rmse'
...
'define bias=div-divr'
'define rmse=sqrt((bias*bias))'
'define rmsem=maskout((rmse),PRESsfc/100-850)'

'set gxout shaded'
'/home/mbojorquez/gscript/color2 1 10 1 -kind white->lightsalmon->crimson->gold'
'd rmsem'
...
'define bias=div-divr'
'define rmse=sqrt((bias*bias))'
'define rmsem=maskout((rmse),PRESsfc/100-700)'
...
'set strsiz 0.14'
'set string 1 c 12 0'
'draw string 5.5 8.35 RMSE para Divergencia/Convergencia (10`a-5 `ns`a-1`n, sombr.)'
...
'!mkdir -p /home/mbojorquez/ETA_TESIS/INICIA_'fec'/RMSE/South_America/Div/MultiNivel/'
'gxprint /home/mbojorquez/ETA_TESIS/INICIA_'fec'/RMSE/South_America/Div/MultiNivel/Div_'fe'_'hora'UTC.png -b /home/mbojorquez/gscript/proyecto_area8.png -t 1 x1024 y768'
