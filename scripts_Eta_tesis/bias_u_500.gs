...
'/home/mbojorquez/gscript/color2 -40 40 5 -kind magenta->darkmagenta->steelblue->white->salmon->crimson->gold'
'set gxout shaded'
'set cthick 10'
...
'draw string 8.2 7.85 BIAS Veloc. Viento (sombr., kt)'
'draw string 2.7 3.85 BIAS Viento zonal (sombr., kt)'
'draw string 7.7 3.85 BIAS Viento meridional (sombr., kt)'



'set strsiz 0.13'
'set string 1 c 12 0'
'draw string 5.5 8.35 BIAS para velocidad de viento (kt), viento zonal/meridional (kt) a 500 hPa'
...
'!mkdir -p /home/mbojorquez/ETA_TESIS/INICIA_'fec'/BIAS/South_America/U/500hPa/'
'gxprint /home/mbojorquez/ETA_TESIS/INICIA_'fec'/BIAS/South_America/U/500hPa/ZonaWind_'fe'_'hora'UTC.png x1024 y768'
