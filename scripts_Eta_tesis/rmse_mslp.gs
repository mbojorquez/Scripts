...
'define rmse = sqrt((slpp*slpp))'


'set gxout shaded'
'/home/mbojorquez/gscript/color2 1 8 1 -kind white->salmon->crimson->yellow'
'd rmse'
...
'set clopts -1 5 0.07'
'set clab masked'
'd maskout(rmse,PRESsfc/100-850)'
...
'define rmse = sqrt((dewp*dewp))'

'/home/mbojorquez/gscript/color2 2 18 2 -kind  white->tomato->firebrick->yellow'
'd rmse'
...
'/home/mbojorquez/gscript/color2 10 50 5 -kind white->salmon->crimson->gold'
'set gxout shaded'
'set cthick 10'
...
'draw string 8.1 7.85 Pres. red. nivel mar (hPa) y espesor 500/1000 hPa'
...
'set strsiz 0.12'
'set string 1 c 11 0'
'draw string 5.5 8.35 RMSE para JS (kt, sombr.), espesores (mgp, contorno) y presion reducida a nivel de mar (hPa, sombr.)'
...
'!mkdir -p /home/mbojorquez/ETA_TESIS/INICIA_'fec'/RMSE/South_America/MSLP/'
'gxprint /home/mbojorquez/ETA_TESIS/INICIA_'fec'/RMSE/South_America/MSLP/MSLP_'fe'_'hora'UTC.png -b /home/mbojorquez/gscript/proyecto_area99.png -t 1 x1024 y768'
