dset ^lat_075_all
index ^lat_075_all.idx
undef 9.999E+20
title lat_075_all
*  produced by grib2ctl v0.9.13
* command line options: -verf lat_075_all
dtype grib 255
ydef 82 linear -50.250000 0.75
xdef 109 linear 244.500000 0.750000
tdef 31 linear 00Z23aug2013 6hr
*  z has 13 levels, for prs
zdef 13 levels
1000 950 925 900 850 700 600 500 400 300 250 200 100
vars 48
no4LFTX180_0mb  0 132,116,46080 ** 180-0 mb above gnd Best (4-layer) lifted index [K]
ABSVprs 13 41,100,0 ** (profile) Absolute vorticity [/s]
...
DPTprs 13 17,100,0 ** (profile) Dew point temp. [K]
...
TMPprs 13 11,100,0 ** (profile) Temp. [K]
...
VVELprs 13 39,100,0 ** (profile) Pressure vertical velocity [Pa/s]
