...
'set strsiz 0.18'
'set string 1 c 12 0'
'draw string 5.5 8.2 LINEAS DE CORRIENTE A 500 hPa (kt) - ETA/SENAMHI'

'set rgb 98 178 34 34'
'set strsiz 0.16'
'set string 98 c 12 0'
'draw string 3.1 7.85 ANALISIS ETA: 'hor'UTC 'di''me''an''

'set string 1 c 12 0'
'draw string 7.7 7.85 VALIDO PARA: 'hora'UTC 'dia''mes''ano
...
'!mkdir /home/mb/ETA_TESIS/INICIA_'fec'/South_America/500hPa/'
'gxprint /home/mb/ETA_TESIS/INICIA_'fec'/South_America/500hPa/LCor500hPa_'fe'_'hora'UTC.png x1024 y768'
