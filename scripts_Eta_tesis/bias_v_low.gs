...
'v1=vgrdprs*1.94'
'vr=vprs.2*1.94'
'v2=maskout((v1-vr),PRESsfc/100-900)'
...
'/home/mbojorquez/gscript/color2 -levs -25 -20 -15 -10 -5 -3 -kind cyan->purple->steelblue->white'
'set gxout shaded'
'd v2'
...
'draw string 2.7 7.85 BIAS Viento meridional a 900 hPa'
'draw string 7.7 7.85 BIAS Viento meridional a 925 hPa'
'draw string 2.7 3.85 BIAS Viento meridional a 950 hPa'
'draw string 7.7 3.85 BIAS Viento meridional a 1000 hPa'



'set strsiz 0.13'
'set string 1 c 12 0'
'draw string 5.5 8.35 BIAS para viento meridional (kt, sombr.) - Niveles bajos'
...
'!mkdir -p /home/mbojorquez/ETA_TESIS/INICIA_'fec'/BIAS/South_America/V/V_LOW/'
'gxprint /home/mbojorquez/ETA_TESIS/INICIA_'fec'/BIAS/South_America/V/V_LOW/MeridionalWind_'fe'_'hora'UTC.png -b /home/mbojorquez/gscript/proyecto_area99.png -t 1 x1024 y768'
