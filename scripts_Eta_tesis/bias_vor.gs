...
'define vor500=maskout((vor-vorr),PRESsfc/100-500)'

'set gxout shaded'
'/home/mbojorquez/gscript/color2 -18 18 2 -kind violet->blue->lightblue->white->lightsalmon->crimson->gold'
'd vor500'
...
'/home/mbojorquez/gscript/color2 -3 -0.5 0.5 -kind lime->darkgreen'
'set gxout contour'
'set cstyle 3'
'd wprs3'
'set clab off'

'/home/mbojorquez/gscript/color2 0.5 3 0.5 -kind black->lightgray'
'set gxout contour'
'set cstyle 1'
'd wprs3'
'set clab off'
...
'd vor-vorr'
'/home/mbojorquez/gscript/cbarn 0.5 1 10.0 6'
...
'/home/mbojorquez/gscript/color2 -3 -0.4 0.3 -kind lime->green'
'set gxout contour'
'set cstyle 3'
'd wprs3'
'set clab off'

'/home/mbojorquez/gscript/color2 0.4 3 0.3 -kind black->aqua'
'set gxout contour'
'set cstyle 1'
'd wprs3'
'set clab off'
...
'set strsiz 0.14'
'set string 1 c 12 0'
'draw string 5.5 8.35 BIAS para Vorticidad relativa (10`a-5 `ns`a-1`n, sombr.) & Veloc. vertical (Pa/s, contor.)'
...
'!mkdir -p /home/mbojorquez/ETA_TESIS/INICIA_'fec'/BIAS/South_America/Vort/MultiNivel/'
'gxprint /home/mbojorquez/ETA_TESIS/INICIA_'fec'/BIAS/South_America/Vort/MultiNivel/Vort_'fe'_'hora'UTC.png -b /home/mbojorquez/gscript/proyecto_area9.png -t 1 x1024 y768'
