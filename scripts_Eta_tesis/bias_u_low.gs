...
'u1=ugrdprs*1.94'
'ur=uprs.2*1.94'
'u2=maskout((u1-ur),PRESsfc/100-900)'
...
'/home/mbojorquez/gscript/color2 -levs 5 10 15 20 25 -kind white->salmon->crimson->gold'
'set gxout shaded'
'd u2'
'/home/mbojorquez/gscript/cbarn 0.5 1 4.9 6.0'

'/home/mbojorquez/gscript/color2 -levs -25 -20 -15 -10 -5 -kind cyan->purple->steelblue->white'
'set gxout shaded'
'd u2'
...
'u1=ugrdprs*1.94'
'ur=uprs.2*1.94'
'u2=maskout((u1-ur),PRESsfc/100-925)'
'set vpage 0 11 0 8.5'
...
'set gxout shaded'
'd u2'
'/home/mbojorquez/gscript/cbarn 0.5 1 10.4 5.9'

*****
'set lev 950'
'u1=ugrdprs*1.94'
'ur=uprs.2*1.94'
'u2=maskout((u1-ur),PRESsfc/100-950)'
'set vpage 0 11 0 8.5'
...
'set gxout shaded'
'd u2'
'/home/mbojorquez/gscript/cbarn 0.5 1 10.4 2'

*****

'set strsiz 0.11'
'set string 1 c 5.9 0'
'draw string 2.7 7.85 BIAS Viento zonal a 900 hPa'
'draw string 7.7 7.85 BIAS Viento zonal a 925 hPa'
'draw string 2.7 3.85 BIAS Viento zonal a 950 hPa'
'draw string 7.7 3.85 BIAS Viento zonal a 1000 hPa'



'set strsiz 0.13'
'set string 1 c 12 0'
'draw string 5.5 8.35 BIAS para viento zonal (kt, sombr.) - Niveles bajos'
...
'!mkdir -p /home/mbojorquez/ETA_TESIS/INICIA_'fec'/BIAS/South_America/U/U_LOW/'
'gxprint /home/mbojorquez/ETA_TESIS/INICIA_'fec'/BIAS/South_America/U/U_LOW/zonalWind_'fe'_'hora'UTC.png -b /home/mbojorquez/gscript/proyecto_area99.png -t 1 x1024 y768'
