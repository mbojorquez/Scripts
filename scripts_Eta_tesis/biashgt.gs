...
'set t 'i''
'define z1=zprs.2(lev=500)/10'
'set t 'i-4''
'define z2=zprs.2(lev=500)/10'
'define dz1=z1-z2'
'define bias=dz-dz1'

'set gxout shaded'
'/home/mbojorquez/gscript/color2 -150 150 10 -kind indigo->darkslateblue->mediumslateblue->royalblue->white->salmon->tomato->crimson->darkred'
...
'set strsiz 0.15'
'set string 1 c 11 0'
'draw string 5.5 8.2 BIAS para Caida de HGT - Eta Vs. Era Interim'
...
'!mkdir /home/mbojorquez/ETA_TESIS/'
'!mkdir /home/mbojorquez/ETA_TESIS/INICIA_'fec'/'
'!mkdir /home/mbojorquez/ETA_TESIS/INICIA_'fec'/BIAS/'
'!mkdir /home/mbojorquez/ETA_TESIS/INICIA_'fec'/BIAS/South_America/'
'!mkdir /home/mbojorquez/ETA_TESIS/INICIA_'fec'/BIAS/South_America/Caida_HGT/'
'gxprint /home/mbojorquez/ETA_TESIS/INICIA_'fec'/BIAS/South_America/Caida_HGT/CaidaHGT_'fe'_'hora'UTC.png -b /home/mbojorquez/gscript/proyecto_area5.png -t 1 x1024 y768'
