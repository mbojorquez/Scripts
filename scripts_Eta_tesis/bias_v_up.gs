...
'draw string 2.7 7.85 BIAS Viento meridional a 250 hPa'
'draw string 7.7 7.85 BIAS Viento meridional a 500 hPa'
'draw string 2.7 3.85 BIAS Viento meridional a 700 hPa'
'draw string 7.7 3.85 BIAS Viento meridional a 850 hPa'



'set strsiz 0.13'
'set string 1 c 12 0'
'draw string 5.5 8.35 BIAS para viento meridional (kt, sombr.)'
...
'!mkdir -p /home/mbojorquez/ETA_TESIS/INICIA_'fec'/BIAS/South_America/V/V_UP/'
'gxprint /home/mbojorquez/ETA_TESIS/INICIA_'fec'/BIAS/South_America/V/V_UP/MeridionalWind_'fe'_'hora'UTC.png x1024 y768'
