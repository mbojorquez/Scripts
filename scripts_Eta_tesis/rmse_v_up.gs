...
'draw string 2.7 7.85 RMSE Viento meridional a 250 hPa'
'draw string 7.7 7.85 RMSE Viento meridional a 500 hPa'
'draw string 2.7 3.85 RMSE Viento meridional a 700 hPa'
'draw string 7.7 3.85 RMSE Viento meridional a 850 hPa'



'set strsiz 0.13'
'set string 1 c 12 0'
'draw string 5.5 8.35 RMSE para viento meridional (kt)'
...
'!mkdir -p /home/mbojorquez/ETA_TESIS/INICIA_'fec'/RMSE/South_America/V/V_UP/'
'gxprint /home/mbojorquez/ETA_TESIS/INICIA_'fec'/RMSE/South_America/V/V_UP/Meridionalwind_up_'fe'_'hora'UTC.png -b /home/mbojorquez/gscript/proyecto_area9.png -t 1 x1024 y768'
