...
'define u2=maskout(u1,spsfc.2/100-850)'
'define v2=maskout(v1,spsfc.2/100-850)'
...
'set strsiz 0.18'
'set string 1 c 12 0'
'draw string 5.5 8.2 LINEAS DE CORRIENTE A 850 hPa (kt) - ERA INTERIM'
...
'!mkdir /home/mb/INTERIM_TESIS/INICIA_'fec'/South_America/850hPa/'
'gxprint /home/mb/INTERIM_TESIS/INICIA_'fec'/South_America/850hPa/LCor850hPa_'fe'_'hora'UTC.png -b /home/mb/gscript/proyecto_area2.png -t 1 x2048 y1536'
