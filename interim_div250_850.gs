...
'd u1;v1;mag(u1,v1)'
'/home/mbojorquez/gscript/cbarn 0.5 1 0.15 6.0'
...
'set gxout shaded'
'd hdivg(uprs3,vprs3)*100000'
'/home/mbojorquez/gscript/cbarn 0.5 1 4.9 2.2'
*'d dprs4*100000'
...
'set gxout shaded'
'd hdivg(uprs3,vprs3)*100000'
'/home/mbojorquez/gscript/cbarn 0.5 1 5.3 2.2'
*'d dprs4*100000'
...
'/home/mbojorquez/gscript/color2 -levs 3 5 10 15 20 25 30 35 40 -kind white->silver->darkgray->gray->dimgray->black'
'set gxout stream'
'set cthick 2'
'set strmden 5'
'd u1;v1;mag(u1,v1)'
...
'draw string 8.6 7.85 850 hPa (Div, sombr.)'
'draw string 3.6 3.85 500 hPa (Div, sombr.)'
'draw string 8.6 3.85 700 hPa (Div, sombr.)'
...
'!mkdir -p /home/mbojorquez/INTERIM_TESIS/INICIA_'fec'/South_America/Div/250_850/'
'gxprint /home/mbojorquez/INTERIM_TESIS/INICIA_'fec'/South_America/Div/250_850/Div_'fe'_'hora'UTC.png -b /home/mbojorquez/gscript/proyecto_area8.png -t 0 x2048 y1536'
