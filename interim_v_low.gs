...
'v1=vprs*1.94'
'v2=maskout(v1,spsfc.2/100-900)'

'/home/mbojorquez/gscript/color2 -levs 5 10 15 20 25 30 35 -kind white->salmon->crimson->gold'
'set gxout shaded'
'd v2'
'/home/mbojorquez/gscript/cbarn 0.5 1 4.9 6.0'

'/home/mbojorquez/gscript/color2 -levs -35 -30 -25 -20 -15 -10 -5 -kind cyan->purple->steelblue->white'
'set gxout shaded'
'd v2'
...
'draw string 2.7 7.85 Viento meridional a 900 hPa'
'draw string 7.7 7.85 Viento meridional a 925 hPa'
'draw string 2.7 3.85 Viento meridional a 950 hPa'
'draw string 7.7 3.85 Viento meridional a 1000 hPa'


'set strsiz 0.13'
'set string 1 c 10 0'
'draw string 5.5 8.35 Grafica multinivel de viento meridional (kt, sombr.) - Niveles bajos'
...
'!mkdir -p /home/mbojorquez/INTERIM_TESIS/INICIA_'fec'/South_America/V/V_LOW/'
'gxprint /home/mbojorquez/INTERIM_TESIS/INICIA_'fec'/South_America/V/V_LOW/Meridionalwind_'fe'_'hora'UTC.png -b /home/mbojorquez/gscript/proyecto_area8.png -t 1 x2048 y1536'
