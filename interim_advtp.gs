...
'define dvortx = cdiff(theta,x)'
'define dvorty = cdiff(theta,y)'
'define dx = cdiff(lon,x)*3.1416/180'
'define dy = cdiff(lat,y)*3.1416/180'
'define advtp = (-1*( (uprs*dvortx)/(cos(lat*3.1416/180)*dx) + vprs*dvorty/dy )/6.37e6)*3600'
'set gxout shaded'
'/home/mbojorquez/gscript/color2 -6 6 1 -kind steelblue->blue->white->red->lightcoral'
...
'define vor=hcurl(uprs,vprs)*1e5'
...
'define advtp = (-1*( (uprs*dvortx)/(cos(lat*3.1416/180)*dx) + vprs*dvorty/dy )/6.37e6)*3600'
'set gxout shaded'
'/home/mbojorquez/gscript/color2 -3 3 0.5 -kind steelblue->blue->white->red->lightcoral'
*'set clevs 10 20 40 60 80'
'd advtp'
*'set clevs -80 -60 -40 -20 -10'
*'d vortadv'
...
'/home/mbojorquez/gscript/color2 -5 -1 0.3 -kind greenyellow->green->darkgray'
'set gxout contour'
'set cstyle 3'
'd wprs2'
'set clab off'
...
'set strsiz 0.13'
'set string 1 c 10 0'
'draw string 5.5 8.35 Advecc. temperatura pot. (K hr`a-1`n, sombr.), Lineas de corriente (kt) & Veloc. vertical (Pa/s, contor.) '
...
'!mkdir -p /home/mbojorquez/INTERIM_TESIS/INICIA_'fec'/South_America/AdvTP/MultiNivel/'
'gxprint /home/mbojorquez/INTERIM_TESIS/INICIA_'fec'/South_America/AdvTP/MultiNivel/AdvTP_'fe'_'hora'UTC.png -b /home/mbojorquez/gscript/proyecto_area7.png -t 1 x2048 y1536'
